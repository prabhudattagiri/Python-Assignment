...
class Prime:
    ...
    # static method (for Check Prime Number)
    def isPrime(self,n):
        if n<=1:
            return False
...
class Number(Prime,Palindrome):
    ...
    def calculateAverage(self):
        ...
        totalPrime = len(self.palindromeList) # total no of prime num
        return (sumOfPrime/totalPrime) if totalPrime > 0 else 0
...
# Get all prime number in the range
obj.getPrimeNum()
